...
function restoreCachedLoadBalancingMap() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield cache.restoreCache([constants_1.SPEC_MAP_PATH], cachePrimaryKey, cacheRestoreKeys);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield restoreCachedLoadBalancingMap();
            const argv = getArgv();
